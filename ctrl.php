...
// Do realizacji tego zadania stworzono dodatkową akcję 'userListPart', która w odróżnieniu od 'userList' generuje samą tabelę.

// Widok strony listy osób został podzielony na dwa widoki: 'userListFullPage.tpl' - wywołany generuje cała stronę Html -
// oraz widok 'userListTable.tpl' - generujący tylko część strony Html (tylko tabelę).

// Sprawdź:
// 1 - dodatkową ścieżkę w routingu
// 2 - dodatkową metodę akcji w kontrolerze userListCtrl
// 3 - widok 'userListFullPage.tpl'
// 4 - widok 'userListTable.tpl'
